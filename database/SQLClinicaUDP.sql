...
CREATE TABLE IF NOT EXISTS `mydb`.`HechosConsultantes` (
  ...
  `genero` VARCHAR(45) NOT NULL,
  `sexo` TINYINT NOT NULL,
  `intentos_contactos` INT NOT NULL DEFAULT 0,
...
BEGIN
UPDATE Paciente SET intentos_contacto = intentos_contactos + 1 WHERE RUT = NEW.Paciente_RUT; 
END$$
